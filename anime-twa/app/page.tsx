    ...
    const fetchData = async () => {
      try {
        ...
        if (resAnimes.ok) {
          ...
          // Últimos 6 animes agregados para la barra lateral
      ...
      <FadeUpSection delayMs={600}>
        <footer className="mt-16 mb-8 pt-8 border-t border-white/10 flex flex-col items-center justify-center gap-6">
          ...
          <div className="flex gap-4 mt-2">
            <a href="https://t.me/SomosInfanimeTV" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-blue-400 hover:bg-blue-500/20 hover:text-blue-300 transition-all active:scale-95 shadow-[0_0_15px_rgba(59,130,246,0.15)]">
            ...
            {/* (Los otros enlaces del footer se mantienen igual) */}
          </div>
        </footer>
      </FadeUpSection>
    </main>
